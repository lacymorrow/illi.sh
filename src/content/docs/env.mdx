...
description: 'Managing environment variables in Next.js implementations'
---

# Environment Variables

NextAccel implementations use Zod for type-safe environment variable validation. This ensures runtime safety and provides excellent developer experience with TypeScript integration.
